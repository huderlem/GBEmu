...
typedef unsigned short  uint16_t;
	...
	// Hit a typedef collision that I wasn't sure how to fix, so I added "2" to the end of these typedefs.
	typedef long            int32_t2;
	typedef unsigned long   uint32_t2;
#elif UINT_MAX == 0xFFFFFFFF
	typedef int             int32_t2;
	typedef unsigned int    uint32_t2;
#else
